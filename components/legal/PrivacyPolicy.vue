  ...
  <div>
    ...
    <section>
      <p>
        ...
        (www.exquisiteescape.com). This privacy policy applies solely to
        information collected by this website. It will inform you of the
        following:
      </p>
      <ol>
        <li>
    ...
    <section>
      ...
      <p>
        ...
        enable us use the information in accordance with this policy.
      </p>
      <p>
    ...
    <section>
      ...
      <p>
        ...
        as credit card data), that information is encrypted and transmitted to
        us in a secure way. You can verify this by looking for a closed lock
        icon at the bottom of your web browser, or looking for "https" at the
    ...
    <section>
      ...
      <p>
        ...
        contact us immediately via telephone at +234 90 7000 5566 or via
        bookings@exquisiteescape.com.
      </p>
    </section>
    <section>
      <h4>Registration</h4>
      <p>
        ...
        is used to contact you about the products/services on our site in which
        you have expressed interest. At your option, you may also provide
    ...
    <section>
      ...
      <p>
        ...
        to identify you, depending on your browser settings you would not have
        to log in a password more than once, thereby saving time while on our
    ...
    <section>
      ...
      <p>
        ...
        identify any individual person. We use a credit card processing company
        to bill users for products and services. These companies do not retain,
        share, store or use personally identifiable information for any
        secondary purposes beyond fulfilling your order.
      </p>
      <p>
        We partner with other parties to provide specific services. When the
      ...
      <p>
        Using the Exquisite Escape SIM card, mobile phone and tablet Apps (the
        "Mobile Apps")
      </p>
      <p>
        When you use a Exquisite Escape SIM Card or Mobile App, we collect and
        use information about you in the same way and for the same purposes as
        we do when you use our website.
      </p>
      <p>
        In addition to this, we also use some other information that we collect
        automatically when you use our Mobile Apps e.g. we collect information
        about Mobile App functionality that you access and use. This allows us
        to identify those areas of the Mobile App that are of interest to our
        customers so that we can refine and continuously improve the Mobile App.
        The information we collect for this purpose does not enable us to
        directly identify you. <br />When you use our Mobile App, you can choose
        to allow access to your current location – provided by your mobile
        device using GPS or similar technologies – in order to identify nearby
        hotels or airports. If you choose to allow access, this location data
        may be collected anonymously as part of search requests logged by our
        servers. You can switch off the Mobile App’s access to your location at
        any time through your phone settings menu. <br />Each Mobile App will
        also send us error-reporting information in the event that it crashes or
        hangs. This enables us to investigate the error and to improve the
        stability of the Mobile App for future releases. We do not use this
        information for any purpose other than investigating and remedying the
        error. <br />You always have the ability to control what information a
        Mobile App sends to us. You can exercise this control either by changing
        the settings of the Mobile App under its setting menu or changing the
        settings of your mobile device. Alternatively, you can remove the Mobile
        App from your mobile device entirely and access our services through our
        website.
      </p>
    </section>
    <section>
    ...
    <section>
      <h4>Visiting our website out for Nigeria</h4>
      <p>
        If you are visiting our website from outside Nigeria, please be aware
        that your information may be transferred to, stored, and processed in
        Nigeria from where our central database is operated. The data protection
        law and other laws of Nigeria may vary in content or may not be as
        comprehensive as those in your country, but please be assured that we
        take steps to ensure that your privacy is protected. By using our
        services, you understand that your information may be transferred to our
        facilities and to those third parties with whom we share it as described
        in this Policy.
      </p>
    </section>
    <section>
      <h4>Surveys & contest/promotions</h4>
      <p>
        ...
        as name and address), and demographic information (such as post code,
        age level etc). Contact information will be used to notify the winners
    ...
    <section>
      ...
      <p>
        ...
        website at http://www.exquisiteescape.com
      </p>
    </section>
    <section>
      <h4>Your consent</h4>
